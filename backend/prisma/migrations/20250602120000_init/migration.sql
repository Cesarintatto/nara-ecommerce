-- CreateEnum
CREATE TYPE "OrderStatus" AS ENUM ('PENDING', 'APPROVED', 'SHIPPED', 'CANCELLED', 'REFUNDED');
...
CREATE TABLE "Product" (
    ...
    "images" TEXT[],
    "stockPhysical" INTEGER NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX "StockReservation_externalId_key" ON "StockReservation"("externalId");
